...
INSERT INTO Persons VALUES (1, 'Сервисный центр LG Russia', '', 1, '127018, Москва, Комсомольский проспект, д.14/1. к.3',
'7(499)372-49-99', 'corp@lg-russia.ru');
INSERT INTO Persons VALUES (2, 'Центральный офис в России', '', 2, '197341, Санкт-Петербург, Коломяжский пр., д.26',
 '8(499)404-18-94', 'info@hakko-shop.ru');
INSERT INTO Persons VALUES (3, 'Ассистент директора по управлению поставками, дистрибуцией и логистикой', 
'Первакова Екатерина Евгеньевна', 4, '105066 г. Москва, ул. Нижняя Красносельская, д.40/12, стр.20', '8(495)644-28-48, добавоч. 7385, 7232', 'ekaterina.prvakova@mvideo.ru');
INSERT INTO Persons VALUES (4, 'Глава отдела по работе с корпоративными клиентами', 'Роман Галиметов', 2, 
'125493 г. Москва, ул. Смольная, д.14', '8-800-250-25-25', 'corp@eldorado.ru');
