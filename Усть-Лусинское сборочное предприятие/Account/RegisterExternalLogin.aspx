<%@ Page Language="C#" Title="Register an external login" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="Усть_Лусинское_сборочное_предприятие.Account.RegisterExternalLogin" %>
